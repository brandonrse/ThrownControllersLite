...
(function (objects) {
    var EasyQuestion = /** @class */ (function (_super) {
        ...
        EasyQuestion.prototype.loadTrickyQuestions = function () {
            ...
            this.questions.push(new objects.Question("In LEGO Star Wars: the Complete Saga, the characters must tell their story without the ability to speak. How does Darth Vader reveal to Luke that he is his father?", ["POINTING TO A PHOTO", "A PHOTO", "POINTING TO PHOTO", "POINTING A PHOTO", "SHOWS HIM A PHOTO", "SHOW HIM A PHOTO", "SHOW HIM PHOTO", "POINTS AT A PHOTO", "POINTS AT PHOTO"], "Darth Vader points to a photo of Anakin and Padme, and then to Luke. The message is conveyed."));
